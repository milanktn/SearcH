...
public class ClientSearchCandidateSameCompany {
	
	WebDriver driver;
	
	@Parameters({"Browser name", "URL", "Client email", "Password", "Candidate email", "Company name"})
	@Test
	public void testClientSearchCandidateSameCompany(String browserName, String url, String clientEmail, String password, String candidateEmail, String companyName
