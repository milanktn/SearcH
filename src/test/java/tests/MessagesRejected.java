...
public class MessagesRejected {
	...
	@Parameters({"Browser name", "URL", "Client email", "Password", "Job title candidate", "Message to candidate", "Message to candidateL2",
		"Candidate email"})
	@Test
	public void testMessagesRejected(String browserName, String url, String clientEmail, String password, String jobTitleCandidate,
		...
		driver.findElement(By.xpath("//button[contains(text(),'Thank you, but I am not interested.')]")).click();

		driver.findElement(By.xpath("//button[contains(text(),'Not interested')]")).click();

		Thread.sleep(2000);
		
		String chatRejectedCandidate = driver.findElement(By.xpath("//body/div[@id='root']/div[2]/div[1]/div[1]/div[5]/div[1]/p[1]")).getText();

		Assert.assertEquals(chatRejectedCandidate, "Chat request rejected");
		...
		String chatRejectedClient = driver.findElement(By.xpath("//body/div[@id='root']/div[2]/div[1]/div[1]/div[5]/div[1]/p[1]")).getText();

		Assert.assertEquals(chatRejectedClient, "Chat request rejected");
	}
