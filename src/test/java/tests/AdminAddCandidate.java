...
public class AdminAddCandidate {
	...
	@Parameters({"Browser name", "URL","Admin email","Admin password", "Candidate first name", "Candidate last name reg",
		"Job title candidate", "CV", "Candidate email reg", "LinkedIn", "Image2", "Salary", "Company name"})
	@Test
	public  void testAdminAddCandidate(String browserName, String url, String adminEmail, String adminPassword, String candidateFirstName,
			String candidateLastNameReg, String jobTitleCandidate, String cv, String candidateEmailReg,
			String linkedIn, String image2, String salary, String companyName) throws InterruptedException {
		...
		driver.findElement(By.id("react-select-4-input")).sendKeys(companyName);
