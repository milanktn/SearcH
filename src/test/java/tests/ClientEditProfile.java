...
public class ClientEditProfile {
	...
	@Parameters({"Browser name", "URL", "Client email", "Password", "Client first name", "Client last name",
		"Job title client", "Company name", "LinkedIn", "Image", "About me client", "About me clientL2"})
	@Test
	public void testClientEditProfile(String browserName, String url, String clientEmail, String password,
			String clientFirstName, String clientLastName, String jobTitleClient, String companyName,
		...
		driver.findElement(By.id("react-select-7-input")).sendKeys(companyName);
