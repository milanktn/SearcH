...
public class CandidateEditExperienceAddCompany {
	
	WebDriver driver;
	
	@Parameters({"Browser name", "URL", "Candidate email", "Password", "Company name reg", "Company website"})
	@Test
	public void testCandidateEditExperienceAddCompany(String browserName, String url, String candidateEmail, String password,
			String companyNameReg, String companyWebsite) throws InterruptedException {
		...
		if (browserName.equalsIgnoreCase("chrome")) {
			...
			driver.findElement(By.xpath(
					"//body/div[@id='root']/div[1]/div[3]/div[2]/div[3]/button[1]")).click();
			
			
			driver.findElement(By.xpath(
					"//body/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]"))
			.click();
			...
			driver.findElement(By.xpath(
					"//body[1]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]"))
			.click();
			...
			driver.findElement(By.xpath(
					"//body/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[4]/div[1]/div[1]/div[2]/div[1]"))
			.click();
			
			driver.findElement(By.xpath(
					"//body[1]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]"))
			.click();
