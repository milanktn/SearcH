...
public class CandidateEditJob {
	
	WebDriver driver;
	
	@Parameters({"Browser name", "URL", "Candidate email", "Password"})
	@Test
	public void testCandidateEditJob(String browserName, String url, String candidateEmail, String password) 
		...
		driver.findElement(By.xpath("//body/div[@id='root']/div[1]/div[3]/div[2]/div[2]/button[1]")).click();
		

		driver.findElement(By.id("requiredSalary")).clear();

		driver.findElement(By.id("requiredSalary")).sendKeys("11000");

		
		driver.findElement(By.xpath(
				"//body/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/*[1]"))
				.click();
		...
		driver.findElement(By.xpath(
				"//body[1]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/button[1]"))
				.click();

		
		driver.findElement(By.xpath(
				"//body/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[2]/div[1]"))
				.click();
		...
		driver.findElement(By.xpath(
				"//body[1]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/button[1]"))
				.click();
